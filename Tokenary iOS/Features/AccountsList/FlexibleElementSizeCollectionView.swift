...
class TestView: UICollectionView {
    override func point(inside point: CGPoint, with event: UIEvent?) -> Bool {
        ...
        return convert(point, to: cell.contentView).x >= .zero
    }
}
...
//        UICollectionViewLayout.copy(super.layoutAttributesForElements(in: rect))
//
//        let layoutAttributesObjects = UICollectionViewLayout.copy(
...
//class FlexibleElementSizeCollectionView: UICollectionViewLayout {
