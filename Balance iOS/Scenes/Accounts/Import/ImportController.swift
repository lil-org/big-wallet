...
class ImportController: NativeHeaderController {
    
    var segmentButtons: [ImportSegmentButton] = []
    ...
    init() {
        super.init(image: nil, title: "New Wallet", subtitle: "You can choose import or create new wallet. Will add it to keychain.")
    }
    ...
    override func viewDidLoad() {
        ...
        let newSegmentButton = ImportSegmentButton()
        ...
        let addSegmentButton = ImportSegmentButton()
    ...
    @objc func didTapSegment(sender: ImportSegmentButton) {
    ...
    @objc func didTapChoose() {
        ...
        if segmentButtons.first?.appearance == .selected {
            ...
            SPAlert.present(title: "New Wallet Added", message: wallet.ethereumAddress, preset: .done)
