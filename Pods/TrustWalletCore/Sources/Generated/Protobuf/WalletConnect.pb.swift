...
public enum TW_WalletConnect_Proto_Protocol: WalletCoreSwiftProtobuf.Enum {
...
public enum TW_WalletConnect_Proto_Method: WalletCoreSwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unknown // = 0
...
extension TW_WalletConnect_Proto_Protocol: WalletCoreSwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: WalletCoreSwiftProtobuf._NameMap = [
    0: .same(proto: "V2"),
  ]
}

extension TW_WalletConnect_Proto_Method: WalletCoreSwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: WalletCoreSwiftProtobuf._NameMap = [
...
extension TW_WalletConnect_Proto_ParseRequestInput: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_WalletConnect_Proto_ParseRequestOutput: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
