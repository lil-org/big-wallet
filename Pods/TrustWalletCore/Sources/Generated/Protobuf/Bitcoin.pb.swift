...
public enum TW_Bitcoin_Proto_TransactionVariant: WalletCoreSwiftProtobuf.Enum {
...
extension TW_Bitcoin_Proto_TransactionVariant: WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_Transaction: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_TransactionInput: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_OutPoint: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_TransactionOutput: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_UnspentTransaction: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_OutputAddress: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_OutputIndex: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_SigningInput: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: WalletCoreSwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 7: try { try decoder.decodeMapField(fieldType: WalletCoreSwiftProtobuf._ProtobufMap<WalletCoreSwiftProtobuf.ProtobufString,WalletCoreSwiftProtobuf.ProtobufBytes>.self, value: &_storage._scripts) }()
  ...
  public func traverse<V: WalletCoreSwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._scripts.isEmpty {
        try visitor.visitMapField(fieldType: WalletCoreSwiftProtobuf._ProtobufMap<WalletCoreSwiftProtobuf.ProtobufString,WalletCoreSwiftProtobuf.ProtobufBytes>.self, value: _storage._scripts, fieldNumber: 7)
      }
...
extension TW_Bitcoin_Proto_TransactionPlan: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_SigningOutput: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_HashPublicKey: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_PreSigningOutput: WalletCoreSwiftProtobuf.Message, WalletCoreSwiftProtobuf._MessageImplementationBase, WalletCoreSwiftProtobuf._ProtoNameProviding {
