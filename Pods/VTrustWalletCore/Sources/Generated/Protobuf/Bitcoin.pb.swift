...
public enum TW_Bitcoin_Proto_TransactionVariant: VSwiftProtobuf.Enum {
...
extension TW_Bitcoin_Proto_TransactionVariant: VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_Transaction: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_TransactionInput: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_OutPoint: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_TransactionOutput: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_UnspentTransaction: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_OutputAddress: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_OutputIndex: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_SigningInput: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: VSwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 7: try { try decoder.decodeMapField(fieldType: VSwiftProtobuf._ProtobufMap<VSwiftProtobuf.ProtobufString,VSwiftProtobuf.ProtobufBytes>.self, value: &_storage._scripts) }()
  ...
  public func traverse<V: VSwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._scripts.isEmpty {
        try visitor.visitMapField(fieldType: VSwiftProtobuf._ProtobufMap<VSwiftProtobuf.ProtobufString,VSwiftProtobuf.ProtobufBytes>.self, value: _storage._scripts, fieldNumber: 7)
      }
...
extension TW_Bitcoin_Proto_TransactionPlan: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_SigningOutput: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_HashPublicKey: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_Bitcoin_Proto_PreSigningOutput: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
