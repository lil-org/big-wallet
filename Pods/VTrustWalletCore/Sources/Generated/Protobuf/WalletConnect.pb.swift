...
public enum TW_WalletConnect_Proto_Protocol: VSwiftProtobuf.Enum {
...
public enum TW_WalletConnect_Proto_Method: VSwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unknown // = 0
...
extension TW_WalletConnect_Proto_Protocol: VSwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: VSwiftProtobuf._NameMap = [
    0: .same(proto: "V2"),
  ]
}

extension TW_WalletConnect_Proto_Method: VSwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: VSwiftProtobuf._NameMap = [
...
extension TW_WalletConnect_Proto_ParseRequestInput: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
...
extension TW_WalletConnect_Proto_ParseRequestOutput: VSwiftProtobuf.Message, VSwiftProtobuf._MessageImplementationBase, VSwiftProtobuf._ProtoNameProviding {
