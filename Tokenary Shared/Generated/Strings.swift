...
struct Strings {
    ...
    static let viewOnTezosScan = "View on Tezos"
    static let viewOnSolanaScan = "View on Solana"
    static let showWalletKey = "Show wallet key"
    ...
    struct ImportViewController {
        static let enterPasswordAlertTitle = "Enter password for importing encrypted data"
        static let enterPasswordAlertDescription = "It seems that your data is encrypted, please specify password to decrypt it."
        static let couldNotDecryptProtectedDataAlertTitle = "We couldn't decrypt protected data!"
    }
}
