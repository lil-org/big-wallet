...
struct Strings {
    ...
    static let importAccountTextFieldPlaceholder = "Paste your Secret Recovery Phrase, Ethereum Private Key or Keystore here."
    ...
    static let privateKey = "Secret Recovery Phrase"
    static let secretWords = "Secret Recovery Phrase"
    ...
    static let importAccount = "Import Wallet"
