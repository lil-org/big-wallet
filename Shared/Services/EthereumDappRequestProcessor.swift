...
struct EthereumDappRequestProcessor {
    ...
    static func prepare(
        ...
        lazy var walletAndAccount = walletsManager.getWalletAndAccount(
            coin: .ethereum,
        ...
        case .signTypedMessage:
            ...
            return prepareMessageSigning(
                request: request,
                walletId: walletAndAccount.0.id,
        ...
        case .signTransaction:
            ...
            let action = SendTransactionAction(
                ...
                guard let privateKey = privateKey(walletId: walletId, account: account) else {
    ...
    private static func privateKey(
        ...
        return walletsManager.getPrivateKey(walletId: walletId, account: account)
    }
